...
struct ICallBackWrapper<void(Args...)> {
  virtual ~ICallBackWrapper() noexcept { 
//	  std::cout << "~ICallBackWrapper()\n"; 
  }
  ...
  virtual void do_call_noexcept(Args... args) const noexcept = 0;
  virtual void do_call_except(Args... args) const = 0;
  virtual void do_call_noexcept(Args... args) volatile noexcept = 0;
  virtual void do_call_except(Args... args) volatile = 0;
