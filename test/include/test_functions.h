...
TFFT(void_f_int_except, TheVoidType, false, false, 1, false, false, int),
    TFFT(void_f_intR_except, TheVoidType, false, false, 1, false, false, int&),
    TFFT(void_f_intRC_except, TheVoidType, false, false, 1, false, false, int const &),
    TFFT(void_f_except,
         TheVoidType,
         false,
         false,
